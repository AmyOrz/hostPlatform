      ...
      ReasonReact.wrapJsForReason(
        ...
        ~props=
          Js.Undefined.{
            ...
            "onFilterDropdownVisibleChange":
              from_opt(onFilterDropdownVisibleChange),
          },
      );
  };
  module ColumnGroup = {
...
module Message = {
  ...
  external successWithCallback: (string, duration, callback) => unit =
    "success";

  [@bs.module "antd/lib/message"]
  external success: (string, duration) => unit = "success";

  [@bs.module "antd/lib/message"]
  external errorWithCallback: (string, duration, callback) => unit = "error";

  [@bs.module "antd/lib/message"]
  external error: (string, duration) => unit = "error";

  [@bs.module "antd/lib/message"]
  external infoWithCallback: (string, duration, callback) => unit = "info";

  [@bs.module "antd/lib/message"]
  external info: (string, duration) => unit = "info";

  [@bs.module "antd/lib/message"]
  external warning: (string, duration, callback) => unit = "";

  [@bs.module "antd/lib/message"]
  external warnWithCallback: (string, duration, callback) => unit = "warn";

  [@bs.module "antd/lib/message"]
  external warn: (string, duration) => unit = "warn";

  [@bs.module "antd/lib/message"]
  external loading: (string, duration, callback) => unit = "";
