var AssetTool = (function () {
    ...
    return {
        getServerPath: function () {
            return "https://server.wonder-3d.com"
        },
        getServerRepoPublish: function (repoId) {
            return "https://server.wonder-3d.com/graphql?query={repoPublish(repoId:" + repoId + "){ wdb_file_path config_dir_path wdb_size }} "
        },
        ...
        loadStreamWDBWithWDBSize: function (wdbPath, wdbSize, handleWhenLoadingFunc, handleBeforeStartLoopFunc, handleWhenDoneFunc, handleWhenLoadWholeWDBFunc, state) {
            return wd.loadStreamWDBWithWDBSize(wdbPath, wdbSize, handleWhenLoadingFunc, handleBeforeStartLoopFunc, handleWhenDoneFunc, handleWhenLoadWholeWDBFunc, state).drain()
        }
    }
})();
